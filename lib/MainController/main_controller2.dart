                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  Column(
                                    children: <Widget>[
                                      Icon(Icons.arrow_forward, color: Color(0xFFC5C5C5),),
                                      Text("SEND", style: TextStyle( fontWeight: FontWeight.w500, color: Color(0xFFC5C5C5)),)
                                    ],
                                  ),
                                  Column(
                                    children: <Widget>[
                                      Icon(Icons.share, color: Color(0xFF1980BA),),
                                      Text("Share", style: TextStyle( color: Color(0xFF1980BA)),)
                                    ],
                                  )
                                ],
