...
class ConfirmSendingPage extends StatefulWidget {
  ...
  @override
  _ConfirmSendingPageSate createState() =>
      _ConfirmSendingPageSate(_transaction);
}
                          ...
                          children: <Widget>[
                            Text("Amount",
                                style: TextStyle(
                                    ...
                                    fontSize: 18,
                                    fontWeight: FontWeight.w400)),
                            Text(transaction['sent_crypto_amount'] + ' BTC ',
                                style: TextStyle(
                                    fontSize: 18,
                                    color: Color(0xFF333333),
                                    fontFamily:
                                        String.fromEnvironment("Montserrat")))
                          ],
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ),
                      ),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                          ...
                          colors: [
                            const Color(0xFF1980BA),
                            const Color(0xFF4AB7E0)
                          ],
